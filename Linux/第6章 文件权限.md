...
![](assets/第6章%20文件权限/file-20251127185229566.png)
...
![](assets/第6章%20文件权限/file-20251127185434314.png)

# 三、基于UGO设置文件权限
![](assets/第6章%20文件权限/file-20251127185844110.png)
###### 基于ugo方式修改权限
...
# 四、chown修改文件拥有者（使用最多）
在 Linux 中，**可以使用 `chown`（change owner） 命令来修改指定文件或目录的拥有者和所属组**。`chown` 命令的基本语法如下：
