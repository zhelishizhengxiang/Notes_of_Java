...
* 图中的方块软引用、弱引用，这四个绿方块自身都是对象，比如c对象也就是gcroot 通过软引用对象间接引用A2 对象
...
```
method1执行结果：  
![](assets/02四种引用——强软弱虚/file-20251117171509377.png)
...
![](assets/02四种引用——强软弱虚/file-20251117173719520.png)
![](assets/02四种引用——强软弱虚/file-20251117173658076.png)
![](assets/02四种引用——强软弱虚/file-20251117173735198.png)
